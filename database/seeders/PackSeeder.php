        ...
        foreach ($packs as $data) {
            ...
            if ($activitiesTableHasCategory) {
                $activitiesToAttach = match ($pack->title) {
                    'Nature & Printemps', 'Jardinage & Découverte' =>
                        Activity::where('category', 'Nature')->where('is_published', true)->pluck('idactivities'),

                    'Pâques & Créations' =>
                        Activity::where('category', 'Pâques')->where('is_published', true)->pluck('idactivities'),

                    'Arts & Couleurs' =>
                        Activity::where('category', 'Art')->where('is_published', true)->pluck('idactivities'),

                    'Jeux & Plein air' =>
                        Activity::where('category', 'Plein air')->where('is_published', true)->pluck('idactivities'),
