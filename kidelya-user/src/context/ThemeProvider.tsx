...
const THEME_VARS: Record<ThemeId, Record<string, string>> = {
  kidelya: {
    ...
    "--color-sidebar-bg":        "#FFFEFA",
    "--color-sidebar-text":      "#273068",
    "--color-sidebar-link":      "#000000",
    "--color-sidebar-active-bg": "#D5CDE2",
    "--color-sidebar-hover-bg":  "#D5CDE2",
