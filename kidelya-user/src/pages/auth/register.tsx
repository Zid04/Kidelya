  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-white p-3">
      ...
      <div className="flex w-full max-w-[960px] overflow-hidden rounded-[20px] shadow-lg">
            ...
            <ul className="mt-6 space-y-4">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#4F5F45]">Des centaines d'activités prêtes à l'emploi ou à créer vous-même.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#4F5F45]">Du lundi au vendredi, 9h à 18h.</p>
                </div>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[#4F5F45]">Vous y trouverez les réponses à vos questions.</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        {/* ── Colonne droite ── */}
        <div className="flex flex-1 flex-col justify-center overflow-y-auto bg-white px-8 py-8">
          <h1 className="text-3xl font-black text-[#273068]">Créer votre compte</h1>
          ...
          <form onSubmit={handleSubmit} className="mt-5 space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="grid gap-1.5">
                ...
                <Input id="firstname" name="firstname" type="text" placeholder="Votre prénom" value={form.firstname} onChange={handleChange} required className="h-11 rounded-xl border border-gray-200 bg-white" />
                <InputError message={errors.firstname ?? null} />
              </div>
              <div className="grid gap-1.5">
                <Label htmlFor="lastname" className="font-semibold text-[#273068]">Nom</Label>
                <Input id="lastname" name="lastname" type="text" placeholder="Votre nom" value={form.lastname} onChange={handleChange} required className="h-11 rounded-xl border border-gray-200 bg-white" />
            ...
            <div className="grid gap-1.5">
              ...
              <Input id="email" name="email" type="email" placeholder="votre@email.com" value={form.email} onChange={handleChange} required className="h-11 rounded-xl border border-gray-200 bg-white" />
              <InputError message={errors.email ?? null} />
            </div>

            <div className="grid gap-1.5">
              <Label htmlFor="password" className="font-semibold text-[#273068]">Mot de passe</Label>
              <PasswordInput id="password" name="password" placeholder="Créez votre mot de passe" value={form.password} onChange={handleChange} required className="h-11 rounded-xl border border-gray-200 bg-white" />
              <p className="text-xs text-[#888]">Minimum 8 caractères, une majuscule, un chiffre et un symbole.</p>
            ...
            <div className="grid gap-1.5">
              ...
              <PasswordInput id="password_confirmation" name="password_confirmation" placeholder="Confirmez votre mot de passe" value={form.password_confirmation} onChange={handleChange} required className="h-11 rounded-xl border border-gray-200 bg-white" />
            ...
            <div className="flex items-start gap-3 pt-1">
              ...
              <label htmlFor="cgu" className="text-xs leading-5 text-[#4F4F4F]">
                J'accepte les{" "}
          ...
          <div className="mt-5 flex items-center justify-center gap-2 text-xs text-[#aaa]">
