...
export default function PlanningCreate() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError(null)
    try {
      await api.post("/plannings", { title, date, idchild: childId })
      navigate("/plannings")
    } catch {
  ...
  return (
    <div className="min-h-screen bg-white px-6 py-10 max-w-xl mx-auto">
      ...
      <h1 className="text-3xl font-bold text-[#93197D] mb-6">Créer un planning 🌸</h1>
      ...
      {!hasSubscription && (
        <div className="mb-6 flex items-start gap-3 rounded-xl border border-[#E94E6F]/30 bg-[#FFF5F7] px-5 py-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#6B7280]">Pour créer des plannings, vous devez changer de plan d'abonnement.</p>
